...
function mapRow(row: GvizRow): AgileTrainingRow[] {
  ...
  return [{
    ...
    especializacionFormadores: getCellText(row.c[3]),
    formadorDeFormadores: getCellText(row.c[4]),
    ced: getCellText(row.c[5]),
    uAtento: getCellText(row.c[6]),
    redefinicionMallaFormacion: getCellText(row.c[7]),
    ...
    desarrolloDigital: getCellText(row.c[13]),
    herramientasDiferenciales: getCellText(row.c[14]),
    metodologiasObjetivos: getCellText(row.c[15]),
    avance: getCellText(row.c[16]),
    piloto: getCellText(row.c[17]),
    pptLanzamiento: getCellText(row.c[18]),
    graduacionOjt: getCellText(row.c[19]),
    resultados: getCellText(row.c[20]),
    ...
    avancePct: parsePercent(row.c[16]),
    pilotoPct: parsePercent(row.c[17]),
