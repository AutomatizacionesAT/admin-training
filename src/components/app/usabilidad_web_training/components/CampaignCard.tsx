...
export default function CampaignCard({ report, onUpdate, onViewDetail }: CampaignCardProps) {
  ...
  const isWarning = porcentaje >= 50 && porcentaje < 100;
  const isSuccess = porcentaje >= 100;
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 bg-white rounded-lg p-1.5 border border-blue-200 focus-within:border-blue-500 ring-2 ring-transparent focus-within:ring-blue-100">
                ...
                <input
                  type="number"
                  className="w-full bg-transparent outline-none text-sm font-bold text-blue-700"
